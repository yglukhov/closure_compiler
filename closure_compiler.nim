import httpclient, cgi, pegs, sets, os, osproc
...
proc runLocalCompiler(compExe, sourceCode: string, level: CompilationLevel): string =
    ...
    discard execProcess(compExe, [inputPath, "--compilation_level", $level,
...
proc runLocalCompiler(compExe, inputPath: string, level: CompilationLevel, srcMap: bool) =
    ...
    var args = @[backupPath, "--compilation_level", $level,
    ...
    discard execProcess(compExe, args, options = {poStdErrToStdOut})
    if srcMap:
